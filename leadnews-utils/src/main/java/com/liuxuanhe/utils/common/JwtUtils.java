...
public class JwtUtils {
     ...
     * @return 用户信息
     */
    public static <T> com.liuxuanhe.utils.common.Payload<T> getInfoFromToken(String token, PublicKey publicKey, Class<T> userType) {
        Jws<Claims> claimsJws = parserToken(token, publicKey);
        Claims body = claimsJws.getBody();
        com.liuxuanhe.utils.common.Payload<T> claims = new com.liuxuanhe.utils.common.Payload<>();
     ...
     * @return 用户信息
     */
    public static <T> com.liuxuanhe.utils.common.Payload<T> getInfoFromToken(String token, PublicKey publicKey) {
        Jws<Claims> claimsJws = parserToken(token, publicKey);
        Claims body = claimsJws.getBody();
        com.liuxuanhe.utils.common.Payload<T> claims = new com.liuxuanhe.utils.common.Payload<>();
        claims.setId(body.getId());
